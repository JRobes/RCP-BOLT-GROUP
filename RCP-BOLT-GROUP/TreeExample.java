...
public class TreeExample extends AbstractE4NatExamplePart {
    ...
    class BodyLayerStack extends AbstractLayerTransform {
        ...
        public BodyLayerStack(
            ...
            TransformedList rowObjectsGlazedList =
            ...
            // ITreeRowModel treeRowModel = new
            // TreeRowModel(treeData);
    ...
    private class PersonWithAddressTreeFormat implements TreeList.Format {
    ...
    private class PersonWithAddressTwoLevelTreeFormat implements TreeList.Format {

        AtomicInteger counter = new AtomicInteger();
        Map lastNames = new HashMap<>();
        Map firstNames = new HashMap<>();
    ...
    class LastNameGroup implements Comparable {
        int id;
        String lastName;
    ...
    class FirstNameGroup implements Comparable {
        String lastName;
        String firstName;
