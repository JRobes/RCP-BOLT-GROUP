...
public class _001_Getting_Started extends AbstractNatExample {
    ...
    private IDataProvider setupBodyDataProvider() {
        final List people = Arrays.asList(new SimplePerson(100,
 ...
 * 
 * 
 public WrapperDataProvider implements IDataProvider {
  private RealDataProvider underlyingDataProvider;
  public WrapperDataProvider(RealDataProvider underlyingDataProvider) {
    this.underlyingDataProvider = underlyingDataProvider;
  }
  public int getColumnCount() {
    return undelryingDataProvider.getColumnCount();
  }
  public int getRowCount() {
    return underlyingDataProvider.getRowCount() + 1;
  }
  public Object getDataValue(int columnIndex, int rowIndex) {
    underlyingDataProvider.getDataValue(columnIndex, rowIndex);
  }
  public void setDataValue(int columnIndex, int rowIndex, Object newValue) {
    if (rowIndex == underlyingDataProvider.getRowCount()) {
      underlyingDataProvider.addRow();
    }
    underlyingDataProvider.setDataValue(columnIndex, rowIndex, newValue);
  }
}
 */
